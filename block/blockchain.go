...
func (bc *Blockchain) Mining() bool {
	...
	for _, n := range bc.neighbors {
		endpoint := fmt.Sprintf("http://%s/consesus", n)
		client := &http.Client{}
...
func (bc *Blockchain) StarMining() {
	bc.Mining()
	_ = time.AfterFunc(time.Second*MINING_TIMER_SEC, bc.StarMining)
}
...
func (bc *Blockchain) ResolveConflicts() bool {
	...
	log.Printf("Resolve conflitcts not replaced")
	return false
}
